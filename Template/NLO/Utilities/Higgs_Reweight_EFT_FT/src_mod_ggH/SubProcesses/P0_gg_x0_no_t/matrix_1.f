...
C     
C     Process: g g > x0 g XGLU=1 WEIGHTED=3 QNP=1 [ real = QCD ] / t
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      DATA NTRY/0/
      DATA IDEN/256/
      double precision AMPgg,AMPLO,sman,tman,uman,dot,pi
...
!      sman =   2d0 * dot(p(0,1), p(0,2))
!      tman = - 2d0 * dot(p(0,1), p(0,4))
!      uman = - 2d0 * dot(p(0,2), p(0,4))
...
c$$$
c$$$      ANS = AMPgg(sman,tman,uman)
c$$$      ANS = ANS * (g**2/(8d0*pi**2))**3
c$$$     f /0.60365910530599576d0 * AMPLOtotop()
c$$$      print*,ANS

      ANS = (g**2/4.d0/pi)**3*AMPgg(sman,tman,uman)
     &     *dsqrt(2.d0)/12.d0/Pi*mh2*AMPLO(mh2)*MDL_GF
c$$$      print*,ANS
c$$$      print*,'--------------------------'
      WGT_ME_REAL=ANS
...
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,2),W(1,4),W(1,5),GC_4,AMP(3))
      CALL VVV1P0_1(W(1,1),W(1,4),GC_4,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VVS2_10_0(W(1,2),W(1,5),W(1,3),GC_3002H,GC_3002A,AMP(4))
