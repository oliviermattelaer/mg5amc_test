...
C     
C     Process: g d~ > x0 d~ XGLU=1 WEIGHTED=3 QNP=1 [ QCD ] / t
C     Process: g u~ > x0 u~ XGLU=1 WEIGHTED=3 QNP=1 [ QCD ] / t
C     Process: g s~ > x0 s~ XGLU=1 WEIGHTED=3 QNP=1 [ QCD ] / t
C     Process: g c~ > x0 c~ XGLU=1 WEIGHTED=3 QNP=1 [ QCD ] / t
C     Process: g b~ > x0 b~ XGLU=1 WEIGHTED=3 QNP=1 [ QCD ] / t
C     
      IMPLICIT NONE
C     
C     CONSTANTS
