...
class CanonicalConfigTag(diagram_generation.DiagramTag):
    ...
    def vertex_from_link(cls, legs, vertex_id, model):
        ...
        if vert_ID != -2:
            ...
            vertex = base_objects.ContractedVertex({'legs': legs,'id': vertex_id[1][0]}) # was -2
...
class HelasMultiProcess(base_objects.PhysicsObject):
    ...
    @classmethod
    def process_color(cls,matrix_element, color_information,gen_color=True, compute_loop_nc=None):
