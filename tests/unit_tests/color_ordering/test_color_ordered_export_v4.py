...
C     ----------
      ...
      JAMP(2)=IFERM(1)*FLOW2(P,NHEL,PERM)
      JAMP(3)=IFERM(1)*FLOW5(P,NHEL,PERM)
      JAMP(4)=IFERM(1)*FLOW3(P,NHEL,PERM)
      JAMP(5)=IFERM(1)*FLOW4(P,NHEL,PERM)
      JAMP(6)=IFERM(1)*FLOW6(P,NHEL,PERM)
      DO I=1,NEXTERNAL
        PERM(I)=PM(PERMS(I,2))
      ENDDO
      JAMP(7)=IFERM(2)*FLOW1(P,NHEL,PERM)
      JAMP(8)=IFERM(2)*FLOW3(P,NHEL,PERM)
      JAMP(9)=IFERM(2)*FLOW5(P,NHEL,PERM)
      DO I=1,NEXTERNAL
        PERM(I)=PM(PERMS(I,3))
      ENDDO
      ...
      DO I=1,NEXTERNAL
        PERM(I)=PM(PERMS(I,4))
      ENDDO
      JAMP(16)=IFERM(4)*FLOW3(P,NHEL,PERM)
      JAMP(17)=IFERM(4)*FLOW4(P,NHEL,PERM)
      JAMP(18)=IFERM(4)*FLOW5(P,NHEL,PERM)
      JAMP(19)=IFERM(4)*FLOW6(P,NHEL,PERM)
      ZTEMP = (0.D0,0.D0)
      ZTEMP = ZTEMP+1/9D0*JAMP(1)*DCONJG(144D0*(JAMP(1))+48D0*(JAMP(2)
     $ +JAMP(10)+JAMP(12)+JAMP(14))+18D0*(JAMP(3)-JAMP(7)+JAMP(9))
     $ +16D0*(JAMP(11)+JAMP(13)+JAMP(15)))
      ZTEMP = ZTEMP+1/9D0*JAMP(2)*DCONJG(48D0*(JAMP(1))+16D0*(JAMP(2)
     $ +JAMP(10)+JAMP(12)+JAMP(14)))
      ZTEMP = ZTEMP+1/9D0*JAMP(4)*DCONJG(144D0*(JAMP(4))+48D0*(JAMP(5)
     $ +JAMP(10)+JAMP(12)+JAMP(16)+JAMP(18))+18D0*(JAMP(8))+16D0
     $ *(JAMP(11)+JAMP(13)+JAMP(17)+JAMP(19)))
      ZTEMP = ZTEMP+1/9D0*JAMP(5)*DCONJG(48D0*(JAMP(4))+16D0*(JAMP(5)
     $ +JAMP(10)+JAMP(12)+JAMP(16)+JAMP(18)))
      ZTEMP = ZTEMP+1/9D0*JAMP(3)*DCONJG(144D0*(JAMP(3))+48D0*(JAMP(6)
     $ +JAMP(10)+JAMP(14)+JAMP(16))+18D0*(JAMP(1)+JAMP(7)-JAMP(9))
     $ +16D0*(JAMP(11)+JAMP(15)+JAMP(17)))
      ZTEMP = ZTEMP+1/9D0*JAMP(6)*DCONJG(48D0*(JAMP(3))+16D0*(JAMP(6)
     $ +JAMP(10)+JAMP(14)+JAMP(16)))
      ONEPERM=ZTEMP
...
C     Select a permutation
      IPERM=1+INT(XRAN1(IDUM)*NPERMS)
 ...
 10     CONTINUE
      ...
      IF (MULTI_CHANNEL) THEN
        ...
        ENDIF
      ENDIF
      ANS=ANS/DBLE(IDEN)*NPERMS
      END

C     ----------------------------------------------
      REAL*8 FUNCTION MATRIX(P,NHEL,PERM)
C     ----------------------------------------------
C     
C     Returns amplitude squared summed/avg over colors
C     for the point with external momenta P(0:3,NEXTERNAL)
...
C     Amplitude(s) for diagram number 5
      ...
      CALL L1_1(W(1,4),W(1,7),G,ZERO, ZERO, W(1,14))
C     Amplitude(s) for diagram number 6
      CALL L1_0(W(1,5),W(1,9),W(1,14),G,AMP(6))
      CALL L1_1(W(1,5),W(1,3),G,ZERO, ZERO, W(1,15))
C     Amplitude(s) for diagram number 7
      CALL L1_0(W(1,15),W(1,2),W(1,14),G,AMP(7))
      CALL L1_1(W(1,6),W(1,4),G,ZERO, ZERO, W(1,16))
      CALL L1_1(W(1,16),W(1,1),G,ZERO, ZERO, W(1,17))
C     Amplitude(s) for diagram number 8
      CALL L1_0(W(1,5),W(1,9),W(1,17),G,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL L1_0(W(1,15),W(1,2),W(1,17),G,AMP(9))
      CALL L1_1(W(1,4),W(1,2),G,ZERO, ZERO, W(1,18))
C     Amplitude(s) for diagram number 10
      CALL L1_0(W(1,3),W(1,18),W(1,8),G,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL L1_0(W(1,15),W(1,18),W(1,7),G,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL L1_0(W(1,3),W(1,18),W(1,13),G,AMP(12))
      CALL L1_1(W(1,3),W(1,7),G,ZERO, ZERO, W(1,19))
C     Amplitude(s) for diagram number 13
      CALL L1_0(W(1,5),W(1,18),W(1,19),G,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL L1_0(W(1,10),W(1,2),W(1,19),G,AMP(14))
      CALL L1_1(W(1,6),W(1,3),G,ZERO, ZERO, W(1,20))
      CALL L1_1(W(1,20),W(1,1),G,ZERO, ZERO, W(1,21))
C     Amplitude(s) for diagram number 15
      CALL L1_0(W(1,5),W(1,18),W(1,21),G,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL L1_0(W(1,10),W(1,2),W(1,21),G,AMP(16))
      CALL L1_1(W(1,5),W(1,2),G,ZERO, ZERO, W(1,22))
C     Amplitude(s) for diagram number 17
      CALL L1_0(W(1,3),W(1,22),W(1,14),G,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL L1_0(W(1,11),W(1,22),W(1,7),G,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL L1_0(W(1,3),W(1,22),W(1,17),G,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL L1_0(W(1,4),W(1,22),W(1,19),G,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL L1_0(W(1,4),W(1,22),W(1,21),G,AMP(21))
      CALL L1_1(W(1,3),W(1,1),G,ZERO, ZERO, W(1,23))
      CALL L1_1(W(1,6),W(1,23),G,ZERO, ZERO, W(1,24))
C     Amplitude(s) for diagram number 22
      CALL L1_0(W(1,5),W(1,18),W(1,24),G,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL L1_0(W(1,12),W(1,18),W(1,23),G,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL L1_0(W(1,10),W(1,2),W(1,24),G,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL L1_0(W(1,4),W(1,22),W(1,24),G,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL L1_0(W(1,16),W(1,22),W(1,23),G,AMP(26))
      CALL L1_1(W(1,4),W(1,23),G,ZERO, ZERO, W(1,25))
C     Amplitude(s) for diagram number 27
      CALL L1_0(W(1,6),W(1,22),W(1,25),G,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL L1_0(W(1,12),W(1,2),W(1,25),G,AMP(28))
      CALL L1_1(W(1,11),W(1,1),G,ZERO, ZERO, W(1,26))
C     Amplitude(s) for diagram number 29
      CALL L1_0(W(1,6),W(1,22),W(1,26),G,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL L1_0(W(1,12),W(1,2),W(1,26),G,AMP(30))
      CALL L1_1(W(1,6),W(1,2),G,ZERO, ZERO, W(1,27))
C     Amplitude(s) for diagram number 31
      CALL L1_0(W(1,27),W(1,10),W(1,23),G,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL L1_0(W(1,27),W(1,5),W(1,25),G,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL L1_0(W(1,27),W(1,5),W(1,26),G,AMP(33))
      CALL L1_1(W(1,5),W(1,23),G,ZERO, ZERO, W(1,28))
C     Amplitude(s) for diagram number 34
      CALL L1_0(W(1,6),W(1,18),W(1,28),G,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL L1_0(W(1,16),W(1,2),W(1,28),G,AMP(35))
      CALL L1_1(W(1,15),W(1,1),G,ZERO, ZERO, W(1,29))
C     Amplitude(s) for diagram number 36
      CALL L1_0(W(1,6),W(1,18),W(1,29),G,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL L1_0(W(1,16),W(1,2),W(1,29),G,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL L1_0(W(1,27),W(1,4),W(1,28),G,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL L1_0(W(1,27),W(1,4),W(1,29),G,AMP(39))
      CALL L1_1(W(1,4),W(1,1),G,ZERO, ZERO, W(1,30))
      CALL L1_1(W(1,6),W(1,30),G,ZERO, ZERO, W(1,31))
C     Amplitude(s) for diagram number 40
      CALL L1_0(W(1,5),W(1,9),W(1,31),G,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL L1_0(W(1,12),W(1,9),W(1,30),G,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL L1_0(W(1,15),W(1,2),W(1,31),G,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL L1_0(W(1,3),W(1,22),W(1,31),G,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL L1_0(W(1,20),W(1,22),W(1,30),G,AMP(44))
      CALL L1_1(W(1,3),W(1,30),G,ZERO, ZERO, W(1,32))
C     Amplitude(s) for diagram number 45
      CALL L1_0(W(1,6),W(1,22),W(1,32),G,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL L1_0(W(1,12),W(1,2),W(1,32),G,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL L1_0(W(1,27),W(1,15),W(1,30),G,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL L1_0(W(1,27),W(1,5),W(1,32),G,AMP(48))
      CALL L1_1(W(1,5),W(1,30),G,ZERO, ZERO, W(1,33))
C     Amplitude(s) for diagram number 49
      CALL L1_0(W(1,6),W(1,9),W(1,33),G,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL L1_0(W(1,20),W(1,2),W(1,33),G,AMP(50))
      CALL L1_1(W(1,10),W(1,1),G,ZERO, ZERO, W(1,34))
C     Amplitude(s) for diagram number 51
      CALL L1_0(W(1,6),W(1,9),W(1,34),G,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL L1_0(W(1,20),W(1,2),W(1,34),G,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL L1_0(W(1,27),W(1,3),W(1,33),G,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL L1_0(W(1,27),W(1,3),W(1,34),G,AMP(54))
      CALL L1_1(W(1,5),W(1,1),G,ZERO, ZERO, W(1,35))
      CALL L1_1(W(1,6),W(1,35),G,ZERO, ZERO, W(1,36))
C     Amplitude(s) for diagram number 55
      CALL L1_0(W(1,4),W(1,9),W(1,36),G,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL L1_0(W(1,16),W(1,9),W(1,35),G,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL L1_0(W(1,11),W(1,2),W(1,36),G,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL L1_0(W(1,3),W(1,18),W(1,36),G,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL L1_0(W(1,20),W(1,18),W(1,35),G,AMP(59))
      CALL L1_1(W(1,3),W(1,35),G,ZERO, ZERO, W(1,37))
C     Amplitude(s) for diagram number 60
      CALL L1_0(W(1,6),W(1,18),W(1,37),G,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL L1_0(W(1,16),W(1,2),W(1,37),G,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL L1_0(W(1,27),W(1,11),W(1,35),G,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL L1_0(W(1,27),W(1,4),W(1,37),G,AMP(63))
      CALL L1_1(W(1,4),W(1,35),G,ZERO, ZERO, W(1,38))
C     Amplitude(s) for diagram number 64
      CALL L1_0(W(1,6),W(1,9),W(1,38),G,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL L1_0(W(1,20),W(1,2),W(1,38),G,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL L1_0(W(1,27),W(1,3),W(1,38),G,AMP(66))
