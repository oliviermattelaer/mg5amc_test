...
class COHelasMatrixElementTest(unittest.TestCase):
    ...
    def test_matrix_element_uux_ddxssxng(self):
        ...
        goal_wavefunctions =  [[12, 12, 13, 13, 13, 15],
                               [22, 22, 22, 22, 22, 22, 24, 18, 24, 24, 24, 18, 18, 24, 24, 22, 22, 22],
                               [43, 42, 41, 44, 42, 43, 43, 44, 43, 42, 42, 41, 47, 35, 28, 52, 35, 47, 47, 52, 47, 35, 35, 28, 27, 29, 44, 29, 49, 44, 37, 31, 38, 31, 37, 38]]
        goal_amplitudes =  [[4, 4, 4, 4, 4, 6],
                            [11, 11, 11, 11, 11, 11, 10, 4, 10, 10, 10, 4, 4, 10, 10, 10, 10, 10],
                            [22, 24, 24, 22, 24, 22, 22, 22, 22, 24, 24, 24, 19, 7, 3, 19, 7, 19, 19, 19, 19, 7, 7, 3, 4, 10, 22, 10, 22, 22, 14, 13, 13, 13, 10, 13]]
    ...
    def test_matrix_element_uux_uuxddxng(self):
        ...
        goal_wavefunctions =  [[12, 12, 13, 13, 13, 15],
                               [22, 22, 22, 22, 22, 22, 24, 24, 24, 18, 18, 24, 18, 24, 24, 22, 22, 22],
                               [43, 42, 41, 44, 42, 43, 43, 44, 43, 42, 42, 41, 47, 52, 47, 47, 35, 28, 35, 35, 52, 35, 28, 47, 27, 29, 44, 29, 49, 44, 37, 31, 38, 31, 37, 38]]
        goal_amplitudes =  [[4, 4, 4, 4, 4, 6],
                            [11, 11, 11, 11, 11, 11, 10, 10, 10, 4, 4, 10, 4, 10, 10, 10, 10, 10],
                            [22, 24, 24, 22, 24, 22, 22, 22, 22, 24, 24, 24, 19, 19, 19, 19, 7, 3, 7, 7, 19, 7, 3, 19, 4, 10, 22, 10, 22, 22, 14, 13, 13, 13, 10, 13]]
        goal_ndiags =  [[4, 4, 4, 4, 4, 6],
