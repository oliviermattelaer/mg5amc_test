...
C     
C     Process: e+ e- > a a a QED=3 WEIGHTED=3
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > g g QCD=2 QED=0 WEIGHTED=2
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > u u~ QCD=2 QED=2 WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
C     Process: u u~ > u u~ QCD=2 QED=2 WEIGHTED=4
C     Process: u u~ > d d~ QCD=2 QED=2 WEIGHTED=4
C     
C     RETURNS DIFFERENTIAL CROSS SECTION 
