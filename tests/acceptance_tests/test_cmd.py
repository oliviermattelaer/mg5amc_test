...
#        self.do('load processes %s' % self.join_path(_pickle_path,'e+e-_e+e-.pkl'))
        ...
        proc.communicate('100 2 2 0.1 .false.\n'.encode())
    ...
    def test_color_ordered_standalone(self):
        ...
        # Check that the needed ALOHA subroutines are generated
        files = ['FFV1_0.f', 'FFV1P0_3.f', 'VVVV1_0.f', 'sumF2.f', 'FFV1_1.f',
                 'VVV1_0.f', 'VVVV4_0.f', 'sumV2.f', 'FFV1_2.f', 'VVV1P0_1.f',
                 'aloha_functions.f']
    ...
    def test_color_ordered_madevent_output(self):
        """Test output of color ordered MadEvent directory"""
    ...
    def test_madevent_decay_chain(self):
        ...
        proc = subprocess.Popen('./gensym',
                                 ...
                                 cwd=os.path.join(self.out_dir, 'SubProcesses',
                                                  'P1_udx_wp_wp_epve'),
                                 shell=True)
        proc.communicate('100 3 4 0.1 .false.\n'.encode())
